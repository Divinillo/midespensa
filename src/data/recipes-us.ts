...
export const RECIPE_DB_US = [
  // — CHICKEN & POULTRY —
  { id:'us01', name:'Grilled Chicken Breast',      cat:'meat',      kcal:280, prot:42, carbs:0,  fat:11, sugar:0, diets:['omnivora','saludable','paleolitica','keto'],
  ...
  { id:'us02', name:'BBQ Chicken Thighs',          cat:'meat',      kcal:380, prot:32, carbs:12, fat:20, sugar:9, diets:['omnivora'],
  ...
  { id:'us03', name:'Chicken Tacos',               cat:'meat',      kcal:420, prot:30, carbs:38, fat:14, sugar:3, diets:['omnivora','saludable'],
  ...
  { id:'us04', name:'Buffalo Chicken Wings',       cat:'meat',      kcal:440, prot:35, carbs:4,  fat:30, sugar:1, diets:['omnivora'],
  ...
  { id:'us05', name:'Chicken Caesar Salad',        cat:'poultry',   kcal:380, prot:35, carbs:12, fat:20, sugar:2, diets:['omnivora','saludable'],
  ...
  // — BEEF —
  { id:'us06', name:'Classic Cheeseburger',        cat:'meat',      kcal:620, prot:38, carbs:38, fat:32, sugar:6, diets:['omnivora'],
    when:'both', tiempo:'20 min', dificultad:'Easy',
  ...
  { id:'us07', name:'Beef Tacos',                  cat:'meat',      kcal:450, prot:28, carbs:38, fat:18, sugar:3, diets:['omnivora','saludable'],
    when:'both', tiempo:'20 min', dificultad:'Easy',
  ...
  { id:'us08', name:'Beef Stir Fry',               cat:'meat',      kcal:380, prot:30, carbs:22, fat:16, sugar:5, diets:['omnivora','saludable'],
    when:'both', tiempo:'20 min', dificultad:'Easy',
  ...
  { id:'us09', name:'Meatloaf',                    cat:'meat',      kcal:420, prot:32, carbs:18, fat:22, sugar:4, diets:['omnivora'],
  ...
  // — PORK —
  { id:'us10', name:'BBQ Pulled Pork',             cat:'meat',      kcal:480, prot:38, carbs:16, fat:22, sugar:10, diets:['omnivora'],
  ...
  { id:'us11', name:'Pork Chops with Apples',      cat:'meat',      kcal:420, prot:35, carbs:22, fat:18, sugar:14, diets:['omnivora','saludable'],
  ...
  // — PASTA & GRAINS —
  { id:'us12', name:'Mac and Cheese',              cat:'pasta',     kcal:580, prot:22, carbs:58, fat:28, sugar:4, diets:['vegetariano'],
  ...
  { id:'us13', name:'Spaghetti with Meat Sauce',  cat:'pasta',     kcal:540, prot:32, carbs:52, fat:18, sugar:6, diets:['omnivora','saludable'],
  ...
  { id:'us14', name:'Pasta Primavera',             cat:'pasta',     kcal:420, prot:14, carbs:58, fat:14, sugar:5, diets:['vegetariano','saludable'],
  ...
  // — SEAFOOD —
  { id:'us15', name:'Shrimp Tacos',               cat:'seafood',   kcal:360, prot:26, carbs:36, fat:12, sugar:3, diets:['omnivora','saludable'],
    when:'both', tiempo:'20 min', dificultad:'Easy',
  ...
  { id:'us16', name:'Baked Salmon',               cat:'seafood',   kcal:360, prot:38, carbs:2,  fat:20, sugar:0, diets:['omnivora','saludable','paleolitica','keto'],
  ...
  { id:'us17', name:'Clam Chowder',               cat:'seafood',   kcal:380, prot:18, carbs:32, fat:20, sugar:3, diets:['omnivora'],
  ...
  // — VEGETARIAN / SIDES —
  { id:'us18', name:'Mashed Potatoes',            cat:'produce',   kcal:280, prot:5,  carbs:40, fat:12, sugar:2, diets:['vegetariano','saludable'],
    when:'both', tiempo:'30 min', dificultad:'Easy',
  ...
  { id:'us19', name:'Caesar Salad',               cat:'produce',   kcal:300, prot:8,  carbs:18, fat:22, sugar:2, diets:['vegetariano','saludable'],
  ...
  { id:'us20', name:'Black Bean Soup',            cat:'legumes',   kcal:320, prot:16, carbs:48, fat:6,  sugar:4, diets:['vegetariano','vegano','saludable'],
  ...
  { id:'us21', name:'Guacamole',                  cat:'produce',   kcal:180, prot:2,  carbs:10, fat:15, sugar:1, diets:['vegano','saludable','paleolitica','keto'],
  ...
  { id:'us22', name:'Pancakes',                   cat:'dairy',     kcal:380, prot:10, carbs:58, fat:12, sugar:12, diets:['vegetariano'],
  ...
  { id:'us23', name:'Breakfast Scramble',         cat:'dairy',     kcal:320, prot:20, carbs:8,  fat:22, sugar:1, diets:['vegetariano','saludable','keto'],
  ...
  // — SOUPS & STEWS —
  { id:'us24', name:'Chicken Noodle Soup',        cat:'poultry',   kcal:280, prot:24, carbs:28, fat:7,  sugar:3, diets:['omnivora','saludable'],
  ...
  { id:'us25', name:'Beef Chili',                 cat:'meat',      kcal:420, prot:32, carbs:30, fat:16, sugar:5, diets:['omnivora','saludable'],
  ...
  // — SANDWICHES / HANDHELD —
  { id:'us26', name:'Grilled Cheese Sandwich',    cat:'dairy',     kcal:420, prot:16, carbs:36, fat:24, sugar:2, diets:['vegetariano'],
    when:'both', tiempo:'10 min', dificultad:'Easy',
  ...
  { id:'us27', name:'BLT Sandwich',               cat:'meat',      kcal:480, prot:18, carbs:34, fat:28, sugar:3, diets:['omnivora'],
    when:'lunch', tiempo:'15 min', dificultad:'Easy',
  ...
  // — QUICK & EASY —
  { id:'us28', name:'Avocado Toast',              cat:'produce',   kcal:320, prot:8,  carbs:30, fat:18, sugar:1, diets:['vegetariano','vegano','saludable'],
  ...
  { id:'us29', name:'Quesadillas',                cat:'dairy',     kcal:440, prot:20, carbs:40, fat:22, sugar:2, diets:['vegetariano'],
  ...
  { id:'us30', name:'Veggie Fried Rice',          cat:'produce',   kcal:380, prot:10, carbs:55, fat:12, sugar:3, diets:['vegetariano','saludable'],
    when:'both', tiempo:'20 min', dificultad:'Easy',
